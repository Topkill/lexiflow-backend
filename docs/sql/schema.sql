...
CREATE TABLE IF NOT EXISTS `user_settings` (
  ...
  `enable_daily_report` TINYINT(1) NOT NULL DEFAULT 1 COMMENT '是否启用日报入口',
...
CREATE TABLE IF NOT EXISTS `user_ai_config` (
  ...
  `stream_enabled` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '是否使用流式输出',
...
CREATE TABLE IF NOT EXISTS `word_import_task` (
  ...
  `file_path` VARCHAR(512) NOT NULL COMMENT '本地文件路径',
  `duplicate_strategy` VARCHAR(32) NOT NULL DEFAULT 'SKIP' COMMENT '重复处理策略：SKIP、OVERWRITE、FILL_EMPTY',
  `status` VARCHAR(32) NOT NULL DEFAULT 'PENDING' COMMENT '导入状态',
...
CREATE TABLE IF NOT EXISTS `study_plan` (
  ...
  `status` VARCHAR(32) NOT NULL DEFAULT 'ACTIVE' COMMENT '计划状态',
  ...
  `is_primary` TINYINT(1) NOT NULL DEFAULT 1 COMMENT '是否主计划',
  `created_at` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT '创建时间',
  `updated_at` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3) COMMENT '更新时间',
  `deleted` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '逻辑删除',
...
CREATE TABLE IF NOT EXISTS `user_word_state` (
  ...
  `mastery_status` VARCHAR(32) NOT NULL DEFAULT 'NEW' COMMENT '当前掌握状态',
  `learned` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '是否已学习',
  ...
  `last_feedback` VARCHAR(32) NULL COMMENT '最近反馈',
...
CREATE TABLE IF NOT EXISTS `wrong_word` (
  ...
  `last_source` VARCHAR(32) NOT NULL DEFAULT 'NEW' COMMENT '最近来源：NEW、REVIEW、QUIZ',
...
CREATE TABLE IF NOT EXISTS `ai_public_config` (
  ...
  `active` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '是否当前启用配置',
...
CREATE TABLE IF NOT EXISTS `ai_content_cache` (
  ...
  `content_type` VARCHAR(32) NOT NULL COMMENT 'AI 内容类型',
...
CREATE TABLE IF NOT EXISTS `ai_call_log` (
  ...
  `config_scope` VARCHAR(32) NOT NULL DEFAULT 'PUBLIC' COMMENT 'PUBLIC 或 PRIVATE',
  `content_type` VARCHAR(32) NOT NULL COMMENT 'AI 内容类型',
  `model_name` VARCHAR(128) NOT NULL COMMENT '模型名称',
  `api_base_url` VARCHAR(512) NULL COMMENT 'Base URL，不含 Key',
  `request_hash` VARCHAR(128) NULL COMMENT '请求摘要 hash',
  `status` VARCHAR(32) NOT NULL DEFAULT 'SUCCESS' COMMENT 'SUCCESS 或 FAILED',
...
CREATE TABLE IF NOT EXISTS `cloze_quiz` (
  ...
  `source_type` VARCHAR(32) NOT NULL DEFAULT 'MIXED' COMMENT '生成来源',
  ...
  `explanation` MEDIUMTEXT NULL COMMENT '总体解析',
  `model_name` VARCHAR(128) NULL COMMENT '生成模型',
  `created_at` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT '创建时间',
  `updated_at` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3) COMMENT '更新时间',
  `deleted` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '逻辑删除',
...
CREATE TABLE IF NOT EXISTS `cloze_quiz_blank` (
  ...
  `hint` VARCHAR(255) NULL COMMENT '保留字段：旧版提示，当前默认不展示',
  `explanation` VARCHAR(1024) NULL COMMENT '单空解析',
  `created_at` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT '创建时间',
  `updated_at` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3) COMMENT '更新时间',
  `deleted` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '逻辑删除',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `cloze_attempt_answer` (
  ...
  `correct` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '是否正确',
  `created_at` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT '创建时间',
  `updated_at` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3) COMMENT '更新时间',
  `deleted` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '逻辑删除',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `system_config` (
  ...
  `editable` TINYINT(1) NOT NULL DEFAULT 1 COMMENT '是否后台可编辑',
  `created_by` INT NULL COMMENT '创建人',
  `updated_by` INT NULL COMMENT '更新人',
  `created_at` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT '创建时间',
  `updated_at` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3) COMMENT '更新时间',
